...
<SvelteFlowProvider>
	<div class="relative h-full min-h-100 w-full overflow-hidden rounded-xl bg-surface-950/75">
		{#if loading}
		...
		{:else if error}
			<div class="flex h-full min-h-100 items-center justify-center backdrop-blur-2xl">
