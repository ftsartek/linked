...
>
	<Combobox.Control>
		<Combobox.Input
			...
			class="w-full rounded-lg border-2 border-secondary-950 bg-black px-3 py-2 text-white placeholder-surface-400 focus:border-primary-800 focus:outline-none"
		/>
